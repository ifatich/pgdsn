...
const InputFile = forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement> & InputFileProps
  ...
  return (
    <div className="file-container">
        ...
        className={
            !(variant === "image") && 
            file
                ? `input-container file-input-all-filled ${file? null : "h-40"}`
                : " input-container file-input-empty"
        }
        >
        <input
            ref={inputRef}
            type="file"
            className={
            file === undefined ? "input-visible" : "input-hidden"
            }
            accept={
            variant === "image"
                ? "image/*"
        ...
        />
        {
            file === undefined
                    ...
                    variant === "image"
                        ...
                        :
                        <div className="input-empty-all-instruction">
                    ...
                    variant === "image"
                        ?
                        <div className="input-filled-image">
                        ...
                        :
                        <div className="input-filled-all">
