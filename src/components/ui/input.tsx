    ...
    if((iconLeft && iconright) && (Children.toArray(children).length===1)){
        ...
        return (
                <div className={cn("input")} >
                    ...
                    <input {...props} ref={ref} role="input" type={type ==="password"? isPasswordHidden? "password" : "text":type} placeholder={placeholder} value={props.value} onChange={(e)=> setEnteredText(e.target.value)}/> 
                    {
