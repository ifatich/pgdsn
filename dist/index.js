...
var FilePicker = (0, import_react22.forwardRef)(({ className, file, setFile, children, variant, fileSize, ...props }, ref) => {
  ...
  function handlePickingImage(e) {
    ...
    if (e.target.files) {
      if (e.target.files[0].size / 1e6 <= fileSize) {
        ...
        setError(`File melebihi batas maksimum ${fileSize}mb`);
        console.log(e.target.files[0].size / 1e6);
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
          "input",
          {
            ...
            onChange: file === void 0 ? handlePickingImage : (e) => e.target.remove,
