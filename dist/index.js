...
var Input = (0, import_react7.forwardRef)(
  ({ className, placeholder, type, reset, children, ...props }, ref) => {
    const [enteredText, setEnteredText] = (0, import_react7.useState)(props.defaultValue);
...
var DatePicker = (0, import_react10.forwardRef)(({ className, ...props }, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "date", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: cn("day-list", className), children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "date-picker", children: dates.map((key, date) => dates[date] === 0 ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: cn("nomor", className) }, date) : /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: cn("nomor", dates[date] === currentDate.getDate() && "active"), children: dates[date] }, date)) })
    ] }),
