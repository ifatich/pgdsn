...
var CustomPagination = ({ rowsPerPage, rowCount, onChangePage, currentPage, onChangeRowsPerPage }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "flex flex-grow justify-between py-4 gap-2 items-center bg-white", children: [
    /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "flex justify-between items-center", children: [
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("label", { htmlFor: "rows-per-page", className: "font-medium mr-2", children: "Baris per Halaman:" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "flex flex-row gap-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "flex items-center space-x-4", children: [
...
var Table = ({
  ...
  const [resetPaginationToggle, setResetPaginationToggle] = import_react20.default.useState(false);
  const filteredItems = props.data.filter(
    (item) => item.name && item.name.toLowerCase().includes(filterText.toLowerCase())
  );
  const subHeaderComponentMemo = import_react20.default.useMemo(() => {
    const handleClear = () => {
      if (filterText) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "h-fit", children: [
    /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Button, { onClick: () => onChangeRowsPerPage(4, currentPage), children: "4 Rows" }),
    /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Button, { onClick: () => onChangeRowsPerPage(10, currentPage), children: "10 Rows" }),
    /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
