...
var CustomPagination = ({ rowsPerPage, rowCount, onChangePage, currentPage, onChangeRowsPerPage }) => {
  ...
  const [selectedPage, setSelectedPage] = (0, import_react20.useState)(currentPage);
  const pageItems = (0, import_react20.useMemo)(() => {
  ...
  var i = 5;
  const [rowsPerPages, setRowsPerPage] = (0, import_react20.useState)(10);
  const handleRowsPerPageChange = (event) => {
    onChangeRowsPerPage(Number(event.target.value), currentPage);
  };
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "custom-pagination", children: [
    /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "rows-per-page", children: [
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("label", { htmlFor: "rows-per-page", className: "mr-2", children: "Lihat" }),
      /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(
        "select",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("option", { value: 5, children: "5" }),
            /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("option", { value: 10, children: "10" }),
            /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("option", { value: 15, children: "15" }),
            /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("option", { value: 20, children: "20" })
          ]
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("label", { htmlFor: "rows-per-page", className: " ml-2", children: "baris" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: "text-black-50", children: "Menampilkan " + (rowsPerPage * currentPage - (rowsPerPage - 1) + "-" + rowsPerPage * currentPage + " dari " + rowCount + " baris") }),
    /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "table-nav", children: [
      /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "page-select-nav", children: [
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
          "select",
          {
            ...
            className: "border border-gray-300 rounded px-2 py-1",
            children: pageItems.map((page) => /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("option", { value: page.value, children: page.text }, page.value))
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("label", { htmlFor: "page-select", className: "font-medium", children: [
          "dari ",
          totalPages,
          " halaman"
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "next-prev-nav", children: [
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
          Button,
          {
            size: "sm",
...
var FilePicker = (0, import_react22.forwardRef)(({ className, file, setFile, children, variant, fileSize = 1, ...props }, ref) => {
  const inputRef = (0, import_react22.useRef)(null);
  const [error, setError] = (0, import_react22.useState)(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("div", { className: "flex flex-col gap-2", children: [
    /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(
      "div",
      {
        className: !(variant === "image") && file ? `bg-lime-10 rounded-md border border-lime-40 min-h-0 py-3 px-4 ${file ? null : "h-40"}` : "py-4 px-4 bg-white border border-black-40 border-dashed rounded-md relative flex items-center justify-center min-h-40",
        children: [
          ...
          file === void 0 ? variant === "image" ? /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("img", { src: "https://ifatich4.github.io/img/ico-image-upload.1e0a3166.svg", alt: "Upload Icon" }) : /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("div", { className: "flex flex-row gap-2 align-middle", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("img", { className: "object-cover w-full h-full rounded-md", src: file ? URL.createObjectURL(file) : "", alt: "Choosen File" })
          ] }) : /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("div", { className: "w-full relative flex flex-row justify-center items-center", children: [
            /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("strong", { className: "w-full", children: [
              file.name,
              " - ",
              (file.size / 1e6).toFixed(1),
              " MB"
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("svg", { onClick: handleRemoveFile, xmlns: "http://www.w3.org/2000/svg", width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M6.64845 5.2298C6.25257 4.90297 5.66557 4.92476 5.29516 5.29516C4.90161 5.68872 4.90161 6.32679 5.29516 6.72034L8.99149 10.4167L5.29516 14.113C4.90161 14.5065 4.90161 15.1446 5.29516 15.5382C5.66557 15.9086 6.25257 15.9304 6.64845 15.6035L6.72034 15.5382L10.4167 11.8418L14.113 15.5382L14.1849 15.6035C14.5808 15.9304 15.1678 15.9086 15.5382 15.5382C15.9317 15.1446 15.9317 14.5065 15.5382 14.113L11.8418 10.4167L15.5382 6.72034C15.9317 6.32679 15.9317 5.68872 15.5382 5.29516C15.1678 4.92476 14.5808 4.90297 14.1849 5.2298L14.113 5.29516L10.4167 8.99149L6.72034 5.29516L6.64845 5.2298Z", fill: "#58585B" }) })
          ] })
        ]
      }
    ),
    error ? /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(ErrorText, { active: true, children: [
      "File melebihi ",
      fileSize,
      " MB"
    ] }) : file ? null : /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(HelperText, { active: true, children: [
