    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex flex-col gap-[2px]", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: `checkbox-subtitle ${disabled ? "text-black-50" : "text-black-60"} ${!subtitle && "hidden"}`, children: subtitle })
        ] })
      ]
    }
  );
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "flex flex-col gap-[2px]", children: [
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: `radio-title ${disabled ? "text-black-60" : "text-black-80"}`, children: title }),
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: `radio-subtitle ${disabled ? "text-black-50" : "text-black-60"} ${!subtitle && "hidden"}`, children: subtitle })
        ] })
      ]
    }
  );
...
var TimePickerTry = (0, import_react21.forwardRef)(({ className, isOpen, onClose, ...props }, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("div", { className: "flex flex-col", children: /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)(Modal, { className: "w-full sm:w-[360px]", isOpen, setOpen: onClose, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(ModalFooter, { children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(Button, { className: "w-full", onClick: handleGetTime, variant: "primary", size: "md", children: "Tetapkan" }) })
  ] }) });
});
